...
ActiveRecord::Schema.define(version: 2021_04_30_070826) do

  create_table "join_lists", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "project_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["project_id"], name: "index_join_lists_on_project_id"
  ...
  add_foreign_key "join_lists", "projects"
  add_foreign_key "join_lists", "users"
